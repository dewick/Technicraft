 ...
 */
package org.spoutcraft.launcher.gui.components;
...
public class LiteProgressBar extends JProgressBar implements Transparent{
    ...
    g2d.fillRect(0, 0, getWidth(), getHeight());
		...
		// Draw progress
		g2d.setColor(new Color(255, 92, 4));
    ...
    int x = (int) (getWidth() * getPercentComplete());
		...
		if (this.isStringPainted() && getString().length() > 0) {
			...
			g2d.setColor(Color.WHITE);
			g2d.drawString(white, startWidth, height+3);
			g2d.setColor(Color.BLACK);
			g2d.drawString(this.getString().substring(chars), whiteWidth + startWidth, height+3);
		}
